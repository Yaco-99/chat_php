...
<div class="container-fluid mt-5">
  <div class="row m-0">
    <div class="col-2 border border-dark offset-1 py-2" id="users"></div>
    <div class="col-8 border border-dark p-0">
      <div class="chat-box px-4 pb-2" id="target"></div>
      <div class="message-box d-flex justify-content-between">
        <input class="text-field" type="text" id="message" maxlength="255" />
        <button id="submit">
